...
class Window(QMainWindow):
 def __init__(self):
  super().__init__(); self.state=DraftState(); self.setWindowTitle("Dota Draft Assistant"); self.resize(620,650); self.setStyleSheet("QWidget{background:#171a20;color:#e7eaf0;font:12px Segoe UI} QLineEdit,QComboBox,QListWidget{background:#232832;border:1px solid #3b4352;border-radius:5px;padding:6px} QPushButton{background:#303846;border:0;border-radius:5px;padding:7px}")
